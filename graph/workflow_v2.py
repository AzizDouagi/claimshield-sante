...
def build_workflow_v2(*, audit_service: AuditService | None = None) -> StateGraph:
    ...
    graph.add_edge("medical_risk", "autonomous_decision")
...
def compile_workflow_v2(
    ...
    *,
    ...
    """
    if graph is None:
        graph = build_workflow_v2(audit_service=audit_service)
